...
export const JobCard = ({
  ...
  companyName,
  location,
  buttonText = "Apply Direct",
}: JobCardPropsType) => {
  return (
    <div className="w-full my-3 px-5 py-4 border-2 border-black rounded-2xl flex flex-col gap-5">
...
const HeartButton = () => {
  ...
  return (
    ...
    >
      <HeartIcon
        className={`h-5 w-5 ${isSelected ? "fill-black" : "fill-white"}`}
      />
    </button>
  );
};
